...
<template>
  ...
  >
    ...
    >
      <span
        class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 group-hover:bg-gray-300 group-focus:ring-4 group-focus:ring-white group-focus:outline-none"
      >
        <svg
