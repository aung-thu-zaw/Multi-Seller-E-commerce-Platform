...
<template>
  ...
  >
    <div class="flex-shrink-0">
      ...
      />
      <div
        class="absolute flex items-center justify-center w-5 h-5 ms-6 -mt-5 bg-lightBlue-700 border border-white rounded-full"
      >
        <svg
    ...
    <div class="w-full ps-3">
      <div class="text-gray-600 font-medium text-sm mb-1.5 w-full line-clamp-2">
        {{ __('New product question from :label', { label: notification.data?.user?.name }) }}
