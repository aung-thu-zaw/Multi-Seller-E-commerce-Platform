...
const props = defineProps({ store: Object, storeReviewsForAverageProgressBar: Object })
...
const starRating = (rating) => {
  const totalRatings = props.storeReviewsForAverageProgressBar.filter(
    (review) => review.rating === rating
  )
  const totalReviews = props.storeReviewsForAverageProgressBar.length
...
<template>
  <div class="text-center mb-10">
    ...
    <p class="text-sm font-medium text-gray-600">
      Based on {{ storeReviewsForAverageProgressBar.length }} customer ratings
    </p>
