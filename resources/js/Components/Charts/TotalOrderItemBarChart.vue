...
const formattedMonths = computed(() => {
  return props.thisYearMonthlyOrderLabels.map((month) => monthNames[month - 1])
})
...
onMounted(() => {
  ...
  let ctx = document.getElementById('order-item-bar-chart').getContext('2d')
  ...
  >
    ...
    <div class="p-4 flex-auto">
      <div class="relative h-350-px">
        <canvas id="order-item-bar-chart"></canvas>
      </div>
    </div>
  </div>
</template>
