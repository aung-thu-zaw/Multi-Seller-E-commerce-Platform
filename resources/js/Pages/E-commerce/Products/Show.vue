...
import PeopleWhoViewedProductSection from '@/Components/Sections/PeopleWhoViewedProductSection.vue'
import ProductMainDetailSection from '@/Components/Sections/ProductMainDetailSection.vue'
...
import QuestionAndAnswers from './Partials/QuestionAndAnswers.vue'
import RatingAndReviews from './Partials/RatingAndReviews.vue'
...
<template>
  ...
  <AppLayout>
    <div class="w-[1280px] mx-auto my-5 space-y-5">
      <ProductMainDetailSection :product="product" />
      <div class="flex items-start justify-between gap-x-5">
        <div class="w-full">
          <div class="border border-gray-300 bg-white p-5 rounded-md">
            <nav class="flex space-x-3">
              <Link
                ...
                :class="{
                  'border-b-2 font-semibold border-orange-600 text-orange-600':
                    $page.props.ziggy.query?.tab === 'description' || !$page.props.ziggy.query?.tab
                }"
                preserve-scroll
              >
              ...
              <Link
                ...
                :class="{
                  'border-b-2 font-semibold border-orange-600 text-orange-600':
                    $page.props.ziggy.query?.tab === 'questions-and-answers'
                }"
                preserve-scroll
              >
              ...
              <Link
                ...
                :href="route('products.show', { product: product?.slug })"
                :data="{
                  tab: 'delivery-and-services'
                }"
                class="py-4 px-1 inline-flex items-center gap-x-1.5 text-sm font-medium whitespace-nowrap text-gray-600 hover:text-orange-600"
                :class="{
                  'border-b-2 font-semibold border-orange-600 text-orange-600':
                    $page.props.ziggy.query?.tab === 'delivery-and-services'
                }"
                preserve-scroll
              >
              ...
              <Link
                ...
                :class="{
                  'border-b-2 font-semibold border-orange-600 text-orange-600':
                    $page.props.ziggy.query?.tab === 'ratings-and-reviews'
                }"
                preserve-scroll
              >
          ...
          <div class="mt-3">
                  ...
                  <div class="space-y-5">
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="space-y-1">
                          <h3 class="font-semibold text-sm text-gray-700 line-clamp-2">
                            Naviforce NF9049 | Men’s Dual Movement Stainless Steel Watch, Original,
                            Black & Blue Watch Strap Color:Black
                          </h3>
                      ...
                      <p class="text-sm font-medium text-gray-700">
                        ...
                        similique vitae nobis debitis cupiditate odit incidunt eaque nihil ipsum
                        quasi harum perferendis magni voluptates vel ex, aperiam rerum fugiat
                        laboriosam?
                      </p>
                    </div>
                  </div>
            ...
            <div v-show="$page.props.ziggy.query?.tab === 'ratings-and-reviews'">
              <RatingAndReviews
                :product="product"
        ...
        <div class="w-[400px]">
          <div
            class="flex flex-col space-y-5 bg-white py-10 border rounded-md border-gray-200 px-6"
          >
            <h1 class="font-bold text-gray-700 text-lg text-center w-full">
              <i class="fa-solid fa-store text-md mr-1"></i>
              From The Same Store
            </h1>
            <ProductGridCard
              v-for="product in productsFromTheSameStore"
              :key="product.id"
              :product="product"
            />
          </div>
