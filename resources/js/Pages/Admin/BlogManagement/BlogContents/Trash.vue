...
<template>
  <AdminDashboardLayout>
    <Head :title="__('Deleted :label', { label: __('Blog Content') })" />
    ...
    <div class="min-h-screen py-10 font-poppins">
      ...
      <div
        v-if="
          can('blog-contents.force.delete') &&
          trashedBlogContents.data.length !== 0
        "
      ...
      >
        ...
        <EmptyTrashButton
          @click="
            permanentDeleteAllAction(
              'Blog Content',
              'admin.blog-contents.force-delete.all'
            )
          "
        />
      </div>
      ...
      <div class="border bg-white rounded-md shadow px-5 py-3">
        ...
        >
          <DashboardTableDataSearchBox
            :placeholder="__('Search by :label', { label: __('Title') }) + '...'"
