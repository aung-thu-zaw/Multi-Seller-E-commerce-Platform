...
const props = defineProps({ shippingMethod: Object })
...
<template>
  <Head :title="__('Edit :label', { label: __('Shipping Method') })" />
    ...
    <div class="min-h-screen py-10 font-poppins">
      ...
      >
        <Breadcrumb to="admin.shipping-methods.index" icon="fa-truck" label="Shipping Methods">
          <BreadcrumbItem :label="shippingMethod.name" />
      ...
      <div class="border p-10 bg-white rounded-md">
        <form
          @submit.prevent="
            editAction('Shipping Method', 'admin.shipping-methods.update', {
