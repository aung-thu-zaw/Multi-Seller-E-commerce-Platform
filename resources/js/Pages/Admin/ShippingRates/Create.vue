...
defineProps({ shippingMethods: Object, shippingAreas: Object })
...
<template>
  <Head :title="__('Create :label', { label: __('Shipping Rate') })" />
  ...
  <AdminDashboardLayout>
    <div class="min-h-screen py-10 font-poppins">
      ...
      <div class="border p-10 bg-white rounded-md">
        <form
          @submit.prevent="createAction('Shipping Rate', 'admin.shipping-rates.store')"
